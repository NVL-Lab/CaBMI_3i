...
def get_bmi_3i_sim_settings(fr: float = 38.6, res: Tuple[int, int] = (403, 390), rec: str = 'R PMT', save: bool = False) -> Dict:
    return {
...
def get_bmi_mat_settings(fr: float = 29.752, res: Tuple[int, int] = (512, 512), rec: str = 'R PMT', save: bool = False) -> Dict:
    # Prairie microscope settings: fr = 29.752, res = (512, 512)
    return {
        'baseline_env': Path('utils/Tseries_baseline_15.env'),
        'bmi_env': Path('utils/Tseries_BMI_30.env'),
        'save': save,
