...
def save_files_3i(save_path, pl, expt_str):
    ...
    save_path_3i = os.path.join(save_path, 'im')
    if not os.path.exists(save_path_3i):
        os.makedirs(save_path_3i)

    save_path_base_3i = os.path.join(save_path_3i, expt_str)
    if not os.path.exists(save_path_base_3i):
        os.makedirs(save_path_base_3i)
